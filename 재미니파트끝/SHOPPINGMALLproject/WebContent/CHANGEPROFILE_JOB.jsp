...
<body>
    ...
    <h1> 직업 변경 </h1>
    <br /> <form action="CHANGEPROFILE_JOB_CHECK.jsp" method="post" onsubmit="return input_check_func()">
    <br /> 
    <br /> 지금 직업 :
    <%
    String strUserName = "dkelab";
	 ...
	 Connection conn = null;
		...
		try {
            ...
            String sql = "SELECT Job FROM CUSTOMER WHERE CUSTOMER_ID='" + session.getAttribute("id") +"'";
            st.executeUpdate(sql);
            ResultSet rs = st.executeQuery(sql);
            
            while(rs.next()) {
                // rs 안에 들어있는 놈이 있다면 값 출력
                out.println(rs.getString("USER_JOB"));
            }
    ...
    %>
    <br /> 
    <br /> 바꿀 직업 : <input id="change_job" name="change_job"> 
    <br /> 
    <br /> <button>변경</button>
    <br /> </form>
    ...
    <script>
        ...
        function input_check_func() {
            var change_hobby = document.getElementById('change_job').value;
