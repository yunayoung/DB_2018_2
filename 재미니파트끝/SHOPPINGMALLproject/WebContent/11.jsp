...
<body>
    ...
    String strUserName = "dkelab";
	 ...
	 Connection conn = null;
        ...
        String sql = "SELECT Iname FROM ITEM WHERE Category_id='11'";
     ...
     rs.next();
            ...
            <input type="hidden"  name="name" value="W835-1159"><br>
            ...
            <input type="submit" value="아이템보기">
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W835-0512"><br>
            <input type="submit" value="아이템보기">
        </form>
                  </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W836-0768"><br>
            <input type="submit" value="아이템보기">
        </form>
