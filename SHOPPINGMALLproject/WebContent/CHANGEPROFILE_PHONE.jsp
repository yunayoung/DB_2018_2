...
<body>
    ...
    <h1> 전화번호 변경 </h1>
    <br /> <form action="CHANGEPROFILE_PHOONE_CHECK.jsp" method="post" onsubmit="return input_check_func()">
    <br /> 
    <br /> 지금 전화번호 :
    <%
    String strUserName = "dkelab";
	 ...
	 Connection conn = null;
		...
		try {
            ...
            String sql = "SELECT Phone_number FROM CUSTOMER WHERE CUSTOMER_ID='" + session.getAttribute("id") +"'";
    ...
    %>
    <br /> 
    <br /> 바꿀 전화번호 : <input id="change_phone" name="change_phone"> 
    <br /> 
    <br /> <button>변경</button>
    <br /> </form>
    ...
    <script>
        ...
        function input_check_func() {
            var change_hobby = document.getElementById('change_phone').value;
