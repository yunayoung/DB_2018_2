...
<body>
    ...
    String strUserName = "dkelab";
	 ...
	 Connection conn = null;
        ...
        String sql = "SELECT Iname FROM ITEM WHERE Category_id='32'";
     ...
     rs.next();
            ...
            <input type="hidden"  name="name" value="W700-0249"><br>
            ...
            <input type="hidden" name="name" value="W700-0258"><br>
            <input type="submit" value="아이템보기">
        </form>
                         </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W723-0044"><br>
            <input type="submit" value="아이템보기">
        </form>
                  </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W723-0053"><br>
            <input type="submit" value="아이템보기">
        </form>
