...
<body>
    ...
    <h1> 이름 변경 </h1>
    <br /> <form action="CHANGEPROFILE_NAME_CHECK.jsp" method="post" onsubmit="return input_check_func()">
    <br /> 
    <br /> 지금 이름 :
    <%
    String strUserName = "dkelab";
	 ...
	 Connection conn = null;
		...
		try {
            ...
            String sql = "SELECT Name FROM CUSTOMER WHERE CUSTOMER_ID='" + session.getAttribute("id") +"'";
    ...
    %>
    <br /> 
    <br /> 바꿀 이름 : <input id="change_name" name="change_name"> 
    <br /> 
    <br /> <button>변경</button>
    <br /> </form>
    ...
    <script>
        ...
        function input_check_func() {
            var change_hobby = document.getElementById('change_name').value;
