...
<body>
    ...
    String strUserName = "dkelab";
	 ...
	 Connection conn = null;
        ...
        String sql = "SELECT Iname FROM ITEM WHERE Category_id='51'";
     ...
     rs.next();
            ...
            <input type="hidden"  name="name" value="W140-4142"><br>
            ...
            <input type="hidden" name="name" value="W140-4221"><br>
            <input type="submit" value="아이템보기">
        </form>
                         </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W879-0297"><br>
            <input type="submit" value="아이템보기">
        </form>
                  </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W879-0303"><br>
            <input type="submit" value="아이템보기">
        </form>
