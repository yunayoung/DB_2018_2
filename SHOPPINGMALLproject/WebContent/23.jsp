...
<body>
    ...
    String strUserName = "dkelab";
     ...
     rs.next();
            ...
            <input type="hidden"  name="name" value="W846-0314"><br>
            ...
            <input type="hidden" name="name" value="W847-0010"><br>
            <input type="submit" value="아이템보기">
        </form>
                         </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W847-1374"><br>
            <input type="submit" value="아이템보기">
        </form>
                  </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W847-2346"><br>
            <input type="submit" value="아이템보기">
        </form>
