...
<body>
    ...
    String strUserName = "dkelab";
	 ...
	 Connection conn = null;
        ...
        String sql = "SELECT Iname FROM ITEM WHERE Category_id='61'";
     ...
     rs.next();
            ...
            <input type="hidden"  name="name" value="W103-9586"><br>
            ...
            <input type="hidden" name="name" value="W103-9595"><br>
            <input type="submit" value="아이템보기">
        </form>
                         </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W801-0340"><br>
            <input type="submit" value="아이템보기">
        </form>
                  </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W801-0775"><br>
            <input type="submit" value="아이템보기">
        </form>
