...
<body>
    ...
    String strUserName = "dkelab";
	 ...
	 Connection conn = null;
        ...
        String sql = "SELECT Iname FROM ITEM WHERE Category_id='63'";
     ...
     rs.next();
            ...
            <input type="hidden"  name="name" value="W805-0056"><br>
            ...
            <input type="hidden" name="name" value="W805-0427"><br>
            <input type="submit" value="아이템보기">
        </form>
                         </br>  아이템
                   	</br> 
                   	...
                   	<form action="ITEM.jsp" method="post">
            <input type="hidden"name="name"  value="W805-1329"><br>
            <input type="submit" value="아이템보기">
        </form>
                  </br>  아이템
                   	</br> 
